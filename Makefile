...
LIBS          = $(SUBLIBS) build/obj/dlink.o -L/usr/lib64 -lcudart -L/usr/lib64/nvidia -lcuda -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
$(TARGET):  $(OBJECTS)  
	/usr/bin/nvcc -I/usr/include/cuda -I/home/i7243466/devel/partycles/include -arch=sm_20 -dlink build/obj/*_cuda.o -o build/obj/dlink.o
...
compiler_lex_clean:
compiler_clean: compiler_cuda_hybrid_clean compiler_cuda_kernels_clean compiler_moc_header_clean 

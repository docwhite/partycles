#############################################################################
# Makefile for building: release/Partycles
...
INCPATH       = -I. -Iinclude -isystem /usr/include/cuda -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -I. -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/i7243466/devel/partycles/release/obj/Partycles1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/opt/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/lib64/nvidia -lcuda -L/usr/lib64 -lcudart -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/main.cpp \
		...
		src/particle.cpp \
		src/particlesystem.cpp moc_viewport.cpp
OBJECTS       = release/cuda/mykernel_cuda.o \
		release/cuda/ramon_cuda.o \
		release/obj/main.o \
		release/obj/viewport.o \
		release/obj/particleswindow.o \
		release/obj/particle.o \
		release/obj/particlesystem.o \
		release/obj/moc_viewport.o
DIST          = kernel/ramon.cu \
		...
		partycles.pro include/viewport.h \
		include/particleswindow.h \
		include/particle.h \
		include/particlesystem.h src/main.cpp \
		src/viewport.cpp \
		src/particleswindow.cpp \
		src/particle.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents kernel/mykernel.cu kernel/ramon.cu $(DISTDIR)/
	$(COPY_FILE) --parents include/viewport.h include/particleswindow.h include/particle.h include/particlesystem.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/viewport.cpp src/particleswindow.cpp src/particle.cpp src/particlesystem.cpp $(DISTDIR)/
...
compiler_cuda_d_make_all: release/cuda/mykernel_cuda.o release/cuda/ramon_cuda.o
compiler_cuda_d_clean:
	-$(DEL_FILE) release/cuda/mykernel_cuda.o release/cuda/ramon_cuda.o
release/cuda/mykernel_cuda.o: include/particle.h \
		kernel/mykernel.cu
	/usr/bin/nvcc -O3 -arch=sm_20 -Xcompiler -Wall -Xcompiler -Wextra -m64 -I/home/i7243466/devel/partycles/include -I /usr/include/cuda -L/usr/lib64/nvidia -lcuda -L/usr/lib64 -lcudart -c -o release/cuda/mykernel_cuda.o kernel/mykernel.cu

release/cuda/ramon_cuda.o: include/particlesystem.h \
		include/particle.h \
		kernel/ramon.cu
	/usr/bin/nvcc -O3 -arch=sm_20 -Xcompiler -Wall -Xcompiler -Wextra -m64 -I/home/i7243466/devel/partycles/include -I /usr/include/cuda -L/usr/lib64/nvidia -lcuda -L/usr/lib64 -lcudart -c -o release/cuda/ramon_cuda.o kernel/ramon.cu

compiler_rcc_make_all:
compiler_rcc_clean:
compiler_moc_header_make_all: moc_viewport.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_viewport.cpp
moc_viewport.cpp: /opt/Qt5.7.0/5.7/gcc_64/include/QtGui/QWindow \
	...
	/opt/Qt5.7.0/5.7/gcc_64/bin/moc $(DEFINES) -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++ -I/home/i7243466/devel/partycles -I/home/i7243466/devel/partycles/include -I/usr/include/cuda -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include include/viewport.h -o moc_viewport.cpp
...
compiler_lex_clean:
compiler_clean: compiler_cuda_d_clean compiler_moc_header_clean 

####### Compile

release/obj/main.o: src/main.cpp /opt/Qt5.7.0/5.7/gcc_64/include/QtGui/QGuiApplication \
...
release/obj/viewport.o: src/viewport.cpp include/viewport.h \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtGui/QWindow \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtGui/qwindow.h \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtCore/QObject \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtCore/qobject.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/obj/viewport.o src/viewport.cpp

release/obj/particleswindow.o: src/particleswindow.cpp /opt/Qt5.7.0/5.7/gcc_64/include/QtGui/QOpenGLShaderProgram \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtGui/qopenglshaderprogram.h \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtCore/qglobal.h \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtCore/qconfig.h \
		/opt/Qt5.7.0/5.7/gcc_64/include/QtCore/qfeatures.h \
		...
		include/particlesystem.h \
		include/particle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/obj/particleswindow.o src/particleswindow.cpp

release/obj/particle.o: src/particle.cpp include/particle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/obj/particle.o src/particle.cpp

release/obj/particlesystem.o: src/particlesystem.cpp include/particlesystem.h \
		include/particle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/obj/particlesystem.o src/particlesystem.cpp

release/obj/moc_viewport.o: moc_viewport.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o release/obj/moc_viewport.o moc_viewport.cpp
